...
import com.hrb.agentspool.tools.EgressGuard;
...
public class InboxController {
 private final InboxConversationRepository conversations; private final InboxMessageRepository messages; private final IntegrationRepository integrations; private final InboxAgentService agentService; private final EgressGuard egress;
 private final HttpClient http=HttpClient.newBuilder().connectTimeout(Duration.ofSeconds(5)).build();
 public InboxController(InboxConversationRepository c,InboxMessageRepository m,IntegrationRepository i,InboxAgentService a,EgressGuard e){conversations=c;messages=m;integrations=i;agentService=a;egress=e;}
